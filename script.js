...
// Function to toggle the red theme
function toggleRedTheme() {
    const body = document.body;
    body.classList.toggle('red-theme');
}

// Event handling for the dark theme button
document.getElementById('red-theme-toggle').addEventListener('click', toggleRedTheme);
...
// Event handling for the dark theme button
document.getElementById('black-theme-toggle').addEventListener('click', toggleBlackTheme);